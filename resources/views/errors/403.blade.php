        ...
        <div class="max-w-xl w-full px-4">
            <div class="text-center">
                ...
                <div class="space-x-4">
                    ...
                    <a href="{{ url('/') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        Home
                    </a>
                    @auth
                        @role('super-admin')
